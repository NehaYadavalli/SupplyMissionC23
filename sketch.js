...
function setup() {
	...
	red2.shapeColor=color(235,64,52);

	red3=createSprite(500,590, 20,100);
	red3.shapeColor=color(235,64,52);
	...
	//Create a Ground
	 ...
	 red2 = Bodies.rectangle(300, 590, 20, 100 , {isStatic:true} );
	 World.add(world, red2);
	 
	 red3 = Bodies.rectangle(500, 590, 20, 100 , {isStatic:true} );
